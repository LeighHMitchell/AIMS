-- Combined Profile & Notifications Migration
...
CREATE POLICY IF NOT EXISTS "Users can view their own record" ON users
  FOR SELECT USING (auth.uid() = auth_id);

CREATE POLICY IF NOT EXISTS "Users can update their own record" ON users
