-- Performance Optimization Indexes for AIMS
-- Created: 2025-07-11
...
-- Drop any duplicate or redundant indexes (if they exist)
-- This is safe as we use IF NOT EXISTS above
...
-- Schedule periodic refresh of materialized view (requires pg_cron extension)
-- Uncomment if pg_cron is available:
-- SELECT cron.schedule('refresh-activity-summaries', '*/15 * * * *', 'SELECT refresh_activity_transaction_summaries();');
