  ...
  ({ className, align = "center", sideOffset = 4, collisionPadding = 8, forcePosition, usePortal = true, ...props }, ref) => {
    ...
    if (usePortal && mounted) {
      const content = (
        <div
          ...
          className={cn(
            "fixed z-[10005] pointer-events-auto rounded-md border bg-white p-4 text-foreground shadow-lg outline-none",
    ...
    return (
      <div
        ref={combinedRef}
        className={cn(
          "absolute z-[10005] w-72 rounded-md border bg-white p-4 text-foreground shadow-md outline-none",
          align === "start" && "left-0",
