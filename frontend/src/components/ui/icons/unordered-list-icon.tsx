  ...
  (
    ...
    return (
      ...
      >
        ...
        <motion.path d="M9 6l11 0" className="list-line-1" style={{ transformOrigin: "9px 6px" }} />
        <motion.path d="M9 12l11 0" className="list-line-2" style={{ transformOrigin: "9px 12px" }} />
        <motion.path d="M9 18l11 0" className="list-line-3" style={{ transformOrigin: "9px 18px" }} />
