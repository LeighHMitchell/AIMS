  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "", // Remove flex classes to let CSS grid override work
        head_cell:
          "text-muted-foreground rounded-md w-9 h-9 font-normal text-[0.8rem]",
        row: "", // Remove flex classes to let CSS grid override work
