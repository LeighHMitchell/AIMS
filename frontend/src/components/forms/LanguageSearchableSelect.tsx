...
const allOptions: Option[] = LANGUAGES.flatMap(group =>
...
interface LanguageSearchableSelectProps {
  value?: string;
...
export function LanguageSearchableSelect({
  value,
  onValueChange,
              ...
              {searchQuery ? (
                ...
                <>
                  ...
                  {commonLanguages.length > 0 && (
                    <>
                      <div className="px-2 py-1.5 text-helper font-semibold text-muted-foreground bg-muted/50">Common Languages</div>
                      <CommandGroup>
                  ...
                  <div className="px-2 py-1.5 text-helper font-semibold text-muted-foreground bg-muted/50">All Languages</div>
                  <CommandGroup>
...
export type { LanguageSearchableSelectProps };