...
const itemClass = "flex items-center gap-2 rounded-lg px-3 py-2.5 text-body text-neutral-700 cursor-pointer";
const successItemClass = "flex items-center gap-2 rounded-lg px-3 py-2.5 text-body text-[hsl(var(--success-icon))] hover:!bg-green-50 cursor-pointer";
const dangerItemClass = "flex items-center gap-2 rounded-lg px-3 py-2.5 text-body text-destructive hover:!bg-destructive/10 cursor-pointer";
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" size="icon" className="h-8 w-8" aria-label="Task actions">
