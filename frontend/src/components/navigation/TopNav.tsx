...
import { LogOut, LogIn, UserPlus, Briefcase, Settings, Shield, MessageSquare, Eye, HelpCircle, Share, Info, Bell, Bookmark, FolderKanban, BarChart3, MapPin } from "@/components/icons/hugeicons"
...
export function TopNav({ user, onLogout }: TopNavProps) {
  ...
  return (
    <nav className="border-b sticky top-0 z-30 bg-white/60 dark:bg-gray-900/60 backdrop-blur-md">
