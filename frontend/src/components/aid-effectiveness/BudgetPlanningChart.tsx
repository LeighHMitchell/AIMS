              ...
              <CardHeader>
                <div className="flex items-start justify-between gap-2">
                  ...
                  <ChartExpandButton
                    ...
                    interpretation="To plan its own budget and service delivery, a recipient government needs to know what external assistance is coming, when, and on what terms. GPEDC captures this through two predictability commitments: Indicator 5b asks whether the development partner has shared its annual disbursement plan with government before the fiscal year starts, and Indicator 6 asks whether it has shared a 3-year forward expenditure plan so government can plan beyond the immediate year. This chart shows what share of activities have shared both, only the annual plan, only the forward plan, or neither. Together, the slices tell you how predictable the country's external assistance actually is from the recipient government's perspective — and therefore how realistic medium-term budget planning can be when so much of the public spending envelope depends on external sources."
                    csv={() => ({
            ...
            <Card className="bg-card">
              <CardHeader>
                <div className="flex items-start justify-between gap-2">
                  ...
                  <ChartExpandButton
                    title={title}
                    interpretation="This is the same predictability picture from the previous chart, but broken down by development partner, sector or country instead of aggregated. Each row's score (0–100) is a composite of how that group performs across the two GPEDC predictability commitments: sharing the annual budget with government before the fiscal year (Indicator 5b) and sharing a 3-year forward plan (Indicator 6). Together the rows tell you which development partners or which sectors are sources of predictable, plannable external assistance for the country, and which are the sources of planning uncertainty — i.e. where the recipient government is having to budget against funding flows it can't reliably forecast."
                    csv={() => ({
