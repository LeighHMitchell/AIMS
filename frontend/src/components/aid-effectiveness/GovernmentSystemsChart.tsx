  ...
  return (
    <div className="space-y-6">
          ...
          <div className="bg-card p-6 rounded-lg border border-border">
            <div className="mb-6 flex items-start justify-between gap-2">
              ...
              <ChartExpandButton
                ...
                interpretation="A country's Public Financial Management (PFM) infrastructure is the set of systems government uses to manage public money: the treasury that holds funds, the budget execution system that controls how they are spent, the financial reporting system that records expenditure, the audit institutions that check it, and the procurement law that governs what can be bought from whom. GPEDC Indicator 5a asks whether external assistance flows through these same country systems or through parallel donor processes that duplicate them. Each bar here represents one of those PFM channels. Together, the picture tells you how genuinely 'on system' the country's external assistance is, i.e. whether activities use, reinforce and build the country's own fiduciary infrastructure, or whether donors are running shadow systems alongside it that will disappear when they leave."
                controls={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {data.map((system) => (
          <Card key={system.system} className="bg-card">
