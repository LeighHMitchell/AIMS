    ...
    <div className="rounded-lg border border-border bg-card hover:border-border transition-colors shadow-sm">
      ...
      {isExpanded && (
        <div className="border-t border-border bg-card p-4">
          <div className="grid grid-cols-3 gap-x-6 gap-y-3 text-helper min-w-0">
            {/* Column 1 */}
              ...
              <div className="text-center py-6">
                ...
                {comprehensiveLog && (
                  <div className="mb-6 p-4 bg-blue-50 border-2 border-blue-200 rounded-lg">
                    <h4 className="text-body font-semibold text-blue-900 mb-2 flex items-center justify-center gap-2">
                      <Info className="h-4 w-4" />
                      Full Import Log
                    </h4>
                    <p className="text-helper text-blue-700 mb-3">
                    ...
                    <p className="text-helper text-blue-600 mt-2">
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {selectedItem.fields.map((field, index) => (
                      <tr key={index} className="bg-card hover:bg-muted">
                        <td className="px-4 py-3 text-center">
                          <Switch
                            checked={field.selected}
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex gap-1">
                  <Button
                    ...
                    className="text-helper px-2 py-1 bg-muted text-foreground border-input hover:bg-muted"
                  >
                    Distribute Equally
                  </Button>
                </div>
          ...
          <div className="border rounded-lg overflow-hidden">
            <table className="w-full">
              <thead className="bg-surface-muted">
                <tr>
                  <th className="px-3 py-2 text-left text-helper font-medium text-muted-foreground uppercase">
                    Original (3-digit)
                  </th>
                  <th className="px-3 py-2 text-left text-helper font-medium text-muted-foreground uppercase">
                    Refined (5-digit)
                  </th>
                  <th className="px-3 py-2 text-left text-helper font-medium text-muted-foreground uppercase w-24">
                    %
                  </th>
                </tr>
              </thead>
                ...
                {nonDacSectors.length > 0 && (
                  <>
                    ...
                    {nonDacSectors.map((sector, index) => {
                      const originalIndex = refinedSectors.findIndex(s => s === sector);
                      return (
                        <tr key={originalIndex} className="bg-muted">
                          <td className="px-3 py-3">
                            <div className="text-body">
                              <div className="font-mono text-xs text-muted-foreground">
                                {sector.originalCode}
                          ...
                          <td className="px-3 py-3">
                            <Input
                              ...
                              value={sector.percentage}
                              disabled
                              className="w-full text-helper bg-muted text-muted-foreground"
                            />
                          </td>
                        </tr>
                      );
        ...
        <DialogFooter>
          <Button variant="outline" onClick={onClose} className="bg-muted text-foreground border-input hover:bg-muted">
            Cancel
          </Button>
          <Button
            onClick={handleSave}
