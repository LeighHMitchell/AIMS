...
export function AddIndicatorForm({
  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => { if (!isOpen) onCancel(); }}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] flex flex-col" onCloseAutoFocus={(e) => e.preventDefault()}>
        <DialogHeader>
        ...
        <ScrollArea className="flex-1 max-h-[calc(90vh-10rem)]">
          <div className="space-y-4 pr-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="indicator-title">Indicator Title <RequiredDot /></Label>
              <Input
                id="indicator-title"
