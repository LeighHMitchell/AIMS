...
export default function TransactionForm({
  ...
  const [formData, setFormData] = useState<TransactionFormData>({
    ...
    flow_type: (transaction?.effective_flow_type || transaction?.flow_type || defaultFlowType || '') as any,
    finance_type: (transaction?.effective_finance_type || transaction?.finance_type || defaultFinanceType || undefined) as any,
    aid_type: transaction?.effective_aid_type || transaction?.aid_type || defaultAidType || '',
    tied_status: (transaction?.effective_tied_status || transaction?.tied_status || defaultTiedStatus || undefined) as any,
  ...
  useEffect(() => {
    if (transaction) {
      ...
      setFormData({
        ...
        sector_code: transaction.sector_code || '',
        recipient_country_code: transaction.recipient_country_code || '',
        flow_type: transaction.effective_flow_type || transaction.flow_type || undefined,
        finance_type: transaction.effective_finance_type || transaction.finance_type || undefined,
        aid_type: transaction.effective_aid_type || transaction.aid_type || '',
        tied_status: transaction.effective_tied_status || transaction.tied_status || undefined,
        financing_classification: transaction.financing_classification || '',
        is_humanitarian: transaction.is_humanitarian ?? false,
      });
    }
