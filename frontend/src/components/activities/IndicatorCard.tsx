          ...
          <CardContent className="pt-0">
            ...
            <div className="space-y-4">
              ...
              {indicator.baseline ? (
                ...
                <p className="text-sm text-gray-500 italic">No baseline data yet — add a starting value to track progress</p>
              )}
            ...
            <div className="space-y-4">
              ...
              {indicator.periods && indicator.periods.length > 0 ? (
                ...
                <div className="text-center py-6 border-2 border-dashed border-gray-200 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">No periods added yet</p>
                  {!readOnly && (
