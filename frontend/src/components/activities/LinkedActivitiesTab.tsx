                      ...
                      <tr key={la.id} className="hover:bg-muted/50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <button
                            ...
                            title="Click to copy"
                            className="text-body font-mono bg-muted text-muted-foreground hover:bg-muted/70 hover:text-foreground transition-colors px-1.5 py-0.5 rounded cursor-pointer"
                          >
                            {la.iatiIdentifier}
                          </button>
                        </td>
