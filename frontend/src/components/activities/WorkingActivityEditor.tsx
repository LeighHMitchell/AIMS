              ...
              >
                {formData.banner ? (
                  ...
                  >
                    ...
                    <p className="text-sm font-medium text-foreground">Click or drag banner image</p>
              ...
              >
                {formData.icon ? (
                  ...
                  >
                    ...
                    <p className="text-sm font-medium text-foreground text-center">Click or drag icon</p>
