...
import { Building2, Home, Settings, FolderPlus, Users, LogOut, User, FileText, Shield, CheckSquare, BarChart3 } from "lucide-react"
        ...
        <aside className="w-64 border-r min-h-[calc(100vh-4rem)] p-4">
          <nav className="space-y-2">
            ...
            <Link href="/analytics" passHref legacyBehavior>
              <Button asChild variant="ghost" className="w-full justify-start">
                <a><BarChart3 className="h-4 w-4 mr-2" />Analytics</a>
              </Button>
            </Link>
