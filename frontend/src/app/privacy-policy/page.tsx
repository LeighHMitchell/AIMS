    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">3. Personal Data Collected</h2>
            <p className="text-foreground leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">4. Purpose of Processing</h2>
            <p className="text-foreground leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">7. Hosting, Data Location, and Security</h2>
            <p className="text-foreground leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">8. Public Data and Personal Information</h2>
            <p className="text-foreground leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">10. Individual Rights</h2>
            <p className="text-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">11. Cookies and Technical Data</h2>
            <p className="text-foreground leading-relaxed">
