...
/**
 * PUT /api/admin/organization-administrative-mappings/:id
 * Update an organization to administrative classification mapping
 */
export async function PUT(
  ...
  try {
    ...
    if (error) {
      console.error("[Admin Mappings] Error updating:", error);
      return NextResponse.json(
...
/**
 * DELETE /api/admin/organization-administrative-mappings/:id
 * Delete an organization to administrative classification mapping
 */
export async function DELETE(
  ...
  try {
    ...
    if (error) {
      console.error("[Admin Mappings] Error deleting:", error);
      return NextResponse.json(
