...
type RouteParams = {
  params: Promise<{ id: string; tripId: string; attachmentId: string }>;
};
...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  ...
  if (error) {
    console.error('[FieldTripAttachments API] Update error:', error);
    return NextResponse.json(
...
export async function DELETE(_request: NextRequest, { params }: RouteParams) {
  ...
  if (error) {
    console.error('[FieldTripAttachments API] Delete error:', error);
    return NextResponse.json(
