// IATI Country Codelist - Version 2.03
// Source: https://iatistandard.org/en/iati-standard/203/codelists/country/

export interface IATICountry {
  code: string;
  name: string;
  withdrawn?: boolean;
}

export const IATI_COUNTRIES: IATICountry[] = [
  ...
  { code: "AN", name: "NETHERLAND ANTILLES", withdrawn: true },
...
// Helper function to get countries by search term
export const searchCountries = (searchTerm: string): IATICountry[] => {
  if (!searchTerm.trim()) return IATI_COUNTRIES;
  
  const term = searchTerm.toLowerCase();
  return IATI_COUNTRIES.filter(country => 
...
export const getCountryByCode = (code: string): IATICountry | undefined => {
  return IATI_COUNTRIES.find(country => country.code === code);
};
